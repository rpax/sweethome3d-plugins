...
public class SweetHome3DWithPlugins extends SweetHome3D {
	...
	private void postHomeReady(Home home) {
		PluginEventBus.get(home).post(new HomeReadyEvent(this, home));
	}
//
//	private List<Plugin> getLoadedPlugins(Home home) {
//		HomeFrameController hfc = this.getHomeFrameController(home);
//		HomePluginController hpc = ((HomePluginController) hfc.getHomeController());
//		return hpc.getPlugins();
//	}
//
//	private void registerPluginsInEventBus(Home home) {
//		for (Plugin plugin : getLoadedPlugins(home)) {
//			PluginEventBus.get(home).register(plugin);
//		}
//	}
//
//	private void unregisterPluginsInEventBus(Home home) {
//		for (Plugin plugin : getLoadedPlugins(home)) {
